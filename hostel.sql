...
--
-- Host: localhost
-- Generation Time: Dec 30, 2020 at 07:45 AM
...
(8, 'kick', 'buttowski', 'admin8@gmail.com', 22, 'admin8'),
(10, 'admin', 'last', 'adminlast@gmail.com', 23, 'adminlast');
...
INSERT INTO `COMPLAINTS` (`Complaint_No`, `Subject`, `Complaint_Status`, `Admin_ID`, `Student_ID`, `Hostel_ID`, `room_no`) VALUES
(1, 'fan not working', 1, 5, 'b180409cs', 11, 1);
...
(2, 'Your complaint :2nd has been rejected.', 5, 'b180409cs'),
(3, 'nasnlkf', 5, '1');
...
('b180001cs', 'meghana', '7894561237', '2000-10-26', 'state2', NULL, NULL, '7895', NULL, NULL, 'maggie@gmail.com', 'F'),
('b180111cs', 'rahul', '1234567891', '2000-10-24', 'Rajasthan', NULL, NULL, '2345', NULL, NULL, 'rahul@gmail.com', 'M'),
('b180299cs', 'mohith', '9490915217', '2000-10-23', 'Andhra', 'b180409cs', 5, '1234', 11, 1, 'mohith@gmail.com', 'M'),
('b180345cs', 'kevin', '4567891230', '2000-10-25', 'state1', NULL, NULL, '3456', NULL, NULL, 'kevin@gmail.com', 'F'),
('b180409cs', 'avinash', '6303520089', '2001-01-08', 'Andhra', 'b180299cs', 5, '0408', 11, 1, 'vi@gmail.com', 'M'),
('b180433cs', 'avinash samudrala', '7995955054', '2020-12-14', 'AP', NULL, NULL, '1234', NULL, NULL, 'vin@gmail.com', 'M'),
...
('b200001cs', 'ssnr1', '2531647981', '1998-10-17', 'state4', NULL, NULL, '1111', NULL, NULL, 'ssnr1@gmail.com', 'M'),
...
--
ALTER TABLE `COMPLAINTS`
  MODIFY `Complaint_No` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `HOSTELS`
--
ALTER TABLE `HOSTELS`
  MODIFY `Hostel_ID` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;

--
-- AUTO_INCREMENT for table `NOTICES`
--
ALTER TABLE `NOTICES`
  MODIFY `Notice_ID` int(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
