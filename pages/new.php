...
session_start();
    ...
    $count_req_q="SELECT COUNT(*) FROM room_requests WHERE receiver_id='$rol_no'";
...
<main>
    <div class="heading" >
      ...
      <div class="content">
        ...
        <input type="submit" class='mybtn' name="choose" value="Hostel update">
        <input type="submit" class='mybtn' name="choose" value="Check Requests">
      </div>
